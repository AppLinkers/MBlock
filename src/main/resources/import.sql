...
insert into currency_info(`id`,`code`,`name`,`img_url`,`trading_site`) values(10,'solusdt@ticker','솔라나', 'https://mblockimg.s3.us-east-2.amazonaws.com/coinLogo/81bd5b74-a1d2-4f56-8226-20deb94b6546','BINANCE');
insert into currency_info(`id`,`code`,`name`,`img_url`,`trading_site`) values(11,'avaxusdt@ticker','아발란체', 'https://mblockimg.s3.us-east-2.amazonaws.com/coinLogo/93ac5762-8ea2-4669-b65d-44a45e214b93','BINANCE');
insert into currency_info(`id`,`code`,`name`,`img_url`,`trading_site`) values(12,'maticusdt@ticker','폴리곤', 'https://mblockimg.s3.us-east-2.amazonaws.com/coinLogo/9b5e8d74-ac47-47d6-aa4e-182d4f3d8724','BINANCE');
insert into currency_info(`id`,`code`,`name`,`img_url`,`trading_site`) values(13,'nearusdt@ticker','니어 프로토콜', 'https://mblockimg.s3.us-east-2.amazonaws.com/coinLogo/ae101f8b-68a5-4dfe-b310-fed72a2b3d42','BINANCE');
insert into currency_info(`id`,`code`,`name`,`img_url`,`trading_site`) values(13,'atomusdt@ticker','코스모스', 'https://mblockimg.s3.us-east-2.amazonaws.com/coinLogo/ae101f8b-68a5-4dfe-b310-fed72a2b3d42','BINANCE');
